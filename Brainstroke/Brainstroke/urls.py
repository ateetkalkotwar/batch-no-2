...
from Brainstroke import views as view
...
urlpatterns = [
    ...
    path('BrainStroke/', users.BrainStroke, name='BrainStroke'),
    path('BrainStrokePrediction/', users.BrainStrokePrediction, name='BrainStrokePrediction'),
